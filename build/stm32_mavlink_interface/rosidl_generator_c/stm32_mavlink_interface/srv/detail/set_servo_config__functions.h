...
#ifndef STM32_MAVLINK_INTERFACE__SRV__DETAIL__SET_SERVO_CONFIG__FUNCTIONS_H_
#define STM32_MAVLINK_INTERFACE__SRV__DETAIL__SET_SERVO_CONFIG__FUNCTIONS_H_
...
/// Initialize srv/SetServoConfig message.
/**
...
/// Finalize srv/SetServoConfig message.
/**
...
/// Create srv/SetServoConfig message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stm32_mavlink_interface__srv__SetServoConfig_Request__init().
...
/// Destroy srv/SetServoConfig message.
/**
 * It calls
 * stm32_mavlink_interface__srv__SetServoConfig_Request__fini()
...
/// Check for srv/SetServoConfig message equality.
/**
...
/// Copy a srv/SetServoConfig message.
/**
...
/// Initialize array of srv/SetServoConfig messages.
/**
...
/// Finalize array of srv/SetServoConfig messages.
/**
 * It calls
 * stm32_mavlink_interface__srv__SetServoConfig_Request__fini()
...
/// Create array of srv/SetServoConfig messages.
/**
 * It allocates the memory for the array and calls
 * stm32_mavlink_interface__srv__SetServoConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetServoConfig messages.
/**
 * It calls
 * stm32_mavlink_interface__srv__SetServoConfig_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetServoConfig message array equality.
/**
...
/// Copy an array of srv/SetServoConfig messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stm32_mavlink_interface__srv__SetServoConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_interface
...
/**
 * It calls
 * stm32_mavlink_interface__srv__SetServoConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_interface
...
/**
 * It allocates the memory for the array and calls
 * stm32_mavlink_interface__srv__SetServoConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_interface
...
/**
 * It calls
 * stm32_mavlink_interface__srv__SetServoConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STM32_MAVLINK_INTERFACE__SRV__DETAIL__SET_SERVO_CONFIG__FUNCTIONS_H_
