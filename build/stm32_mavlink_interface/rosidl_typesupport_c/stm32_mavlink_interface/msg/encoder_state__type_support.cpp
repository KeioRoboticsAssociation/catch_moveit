...
static const _EncoderState_type_support_symbol_names_t _EncoderState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_interface, msg, EncoderState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stm32_mavlink_interface, msg, EncoderState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stm32_mavlink_interface, msg, EncoderState)() {
  return &::stm32_mavlink_interface::msg::rosidl_typesupport_c::EncoderState_message_type_support_handle;
}
