...
set(_exported_dependencies "moveit_core;moveit_kinematics;moveit_ros_planning;pluginlib;rclcpp;tf2_eigen;tf2_geometry_msgs;tf2_kdl;tf2_ros")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to right_arm_ikfast_plugin_DEFINITIONS, right_arm_ikfast_plugin_INCLUDE_DIRS,
# right_arm_ikfast_plugin_LIBRARIES, and right_arm_ikfast_plugin_LINK_FLAGS.
# Additionally collect the direct dependency names in
# right_arm_ikfast_plugin_DEPENDENCIES as well as the recursive dependency names
# in right_arm_ikfast_plugin_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(right_arm_ikfast_plugin_DEPENDENCIES ${_exported_dependencies})
  set(right_arm_ikfast_plugin_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(right_arm_ikfast_plugin_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(right_arm_ikfast_plugin_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(right_arm_ikfast_plugin_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(right_arm_ikfast_plugin_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(right_arm_ikfast_plugin_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND right_arm_ikfast_plugin_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
