...
static const _GetConfig_Request_type_support_symbol_names_t _GetConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, srv, GetConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rogilink_flex_interfaces, srv, GetConfig_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rogilink_flex_interfaces, srv, GetConfig_Request)() {
  return &::rogilink_flex_interfaces::srv::rosidl_typesupport_c::GetConfig_Request_message_type_support_handle;
}
...
static const _GetConfig_Response_type_support_symbol_names_t _GetConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, srv, GetConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rogilink_flex_interfaces, srv, GetConfig_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rogilink_flex_interfaces, srv, GetConfig_Response)() {
  return &::rogilink_flex_interfaces::srv::rosidl_typesupport_c::GetConfig_Response_message_type_support_handle;
}
...
static const _GetConfig_type_support_symbol_names_t _GetConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, srv, GetConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rogilink_flex_interfaces, srv, GetConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rogilink_flex_interfaces, srv, GetConfig)() {
  return &::rogilink_flex_interfaces::srv::rosidl_typesupport_c::GetConfig_service_type_support_handle;
}
