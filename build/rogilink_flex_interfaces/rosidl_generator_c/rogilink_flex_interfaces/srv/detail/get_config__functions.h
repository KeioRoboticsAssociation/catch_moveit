...
#ifndef ROGILINK_FLEX_INTERFACES__SRV__DETAIL__GET_CONFIG__FUNCTIONS_H_
#define ROGILINK_FLEX_INTERFACES__SRV__DETAIL__GET_CONFIG__FUNCTIONS_H_
...
/// Initialize srv/GetConfig message.
/**
...
/// Finalize srv/GetConfig message.
/**
...
/// Create srv/GetConfig message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rogilink_flex_interfaces__srv__GetConfig_Request__init().
...
/// Destroy srv/GetConfig message.
/**
 * It calls
 * rogilink_flex_interfaces__srv__GetConfig_Request__fini()
...
/// Check for srv/GetConfig message equality.
/**
...
/// Initialize array of srv/GetConfig messages.
/**
...
/// Finalize array of srv/GetConfig messages.
/**
 * It calls
 * rogilink_flex_interfaces__srv__GetConfig_Request__fini()
...
/// Create array of srv/GetConfig messages.
/**
 * It allocates the memory for the array and calls
 * rogilink_flex_interfaces__srv__GetConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetConfig messages.
/**
 * It calls
 * rogilink_flex_interfaces__srv__GetConfig_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetConfig message array equality.
/**
...
/// Copy an array of srv/GetConfig messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rogilink_flex_interfaces__srv__GetConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rogilink_flex_interfaces
...
/**
 * It calls
 * rogilink_flex_interfaces__srv__GetConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rogilink_flex_interfaces
...
/**
 * It allocates the memory for the array and calls
 * rogilink_flex_interfaces__srv__GetConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rogilink_flex_interfaces
...
/**
 * It calls
 * rogilink_flex_interfaces__srv__GetConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROGILINK_FLEX_INTERFACES__SRV__DETAIL__GET_CONFIG__FUNCTIONS_H_
