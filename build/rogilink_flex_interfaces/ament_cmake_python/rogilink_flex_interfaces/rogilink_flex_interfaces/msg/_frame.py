...
class Metaclass_Frame(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rogilink_flex_interfaces.msg.Frame')
            logger.debug(
    ...
    @property
    def DEVICE_ID__DEFAULT(cls):
        """Return default value for message field 'device_id'."""
        return 0
...
class Frame(metaclass=Metaclass_Frame):
    ...
    def __init__(self, **kwargs):
        ...
        self.frame_id = kwargs.get(
            'frame_id', Frame.FRAME_ID__DEFAULT)
        self.device_id = kwargs.get(
            'device_id', Frame.DEVICE_ID__DEFAULT)
