...
#include "rogilink_flex_interfaces/msg/detail/frame__rosidl_typesupport_fastrtps_c.h"
...
using _Frame__ros_msg_type = rogilink_flex_interfaces__msg__Frame;
...
size_t get_serialized_size_rogilink_flex_interfaces__msg__Frame(
  const void * untyped_ros_message,
...
static uint32_t _Frame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rogilink_flex_interfaces__msg__Frame(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rogilink_flex_interfaces
size_t max_serialized_size_rogilink_flex_interfaces__msg__Frame(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rogilink_flex_interfaces__msg__Frame;
    is_plain =
      (
...
static size_t _Frame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rogilink_flex_interfaces__msg__Frame(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, msg, Frame)() {
