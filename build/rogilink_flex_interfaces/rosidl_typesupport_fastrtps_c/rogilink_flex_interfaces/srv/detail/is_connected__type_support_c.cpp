...
#include "rogilink_flex_interfaces/srv/detail/is_connected__rosidl_typesupport_fastrtps_c.h"
...
using _IsConnected_Request__ros_msg_type = rogilink_flex_interfaces__srv__IsConnected_Request;
...
size_t get_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Request(
  const void * untyped_ros_message,
...
static uint32_t _IsConnected_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rogilink_flex_interfaces
size_t max_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rogilink_flex_interfaces__srv__IsConnected_Request;
    is_plain =
      (
...
static size_t _IsConnected_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, srv, IsConnected_Request)() {
...
using _IsConnected_Response__ros_msg_type = rogilink_flex_interfaces__srv__IsConnected_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rogilink_flex_interfaces
size_t get_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IsConnected_Response__ros_msg_type * ros_message = static_cast<const _IsConnected_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rogilink_flex_interfaces
size_t max_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rogilink_flex_interfaces__srv__IsConnected_Response;
    is_plain =
      (
...
static size_t _IsConnected_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rogilink_flex_interfaces__srv__IsConnected_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, srv, IsConnected_Response)() {
...
// already included above
// #include "rogilink_flex_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rogilink_flex_interfaces/srv/is_connected.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogilink_flex_interfaces, srv, IsConnected)() {
