...
bool stm32_mavlink_interface__msg__servo_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stm32_mavlink_interface.msg._servo_command.ServoCommand", full_classname_dest, 55) == 0);
  }
  stm32_mavlink_interface__msg__ServoCommand * ros_message = _ros_message;
  {  // header
...
PyObject * stm32_mavlink_interface__msg__servo_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stm32_mavlink_interface.msg._servo_command");
