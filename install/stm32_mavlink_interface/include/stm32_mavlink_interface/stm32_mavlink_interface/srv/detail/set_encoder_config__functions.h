...
#ifndef STM32_MAVLINK_INTERFACE__SRV__DETAIL__SET_ENCODER_CONFIG__FUNCTIONS_H_
#define STM32_MAVLINK_INTERFACE__SRV__DETAIL__SET_ENCODER_CONFIG__FUNCTIONS_H_
...
/// Initialize srv/SetEncoderConfig message.
/**
...
/// Finalize srv/SetEncoderConfig message.
/**
...
/// Create srv/SetEncoderConfig message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Request__init().
...
/// Destroy srv/SetEncoderConfig message.
/**
 * It calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Request__fini()
...
/// Check for srv/SetEncoderConfig message equality.
/**
...
/// Copy a srv/SetEncoderConfig message.
/**
...
/// Initialize array of srv/SetEncoderConfig messages.
/**
...
/// Finalize array of srv/SetEncoderConfig messages.
/**
 * It calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Request__fini()
...
/// Create array of srv/SetEncoderConfig messages.
/**
 * It allocates the memory for the array and calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetEncoderConfig messages.
/**
 * It calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetEncoderConfig message array equality.
/**
...
/// Copy an array of srv/SetEncoderConfig messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_interface
...
/**
 * It calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_interface
...
/**
 * It allocates the memory for the array and calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_interface
...
/**
 * It calls
 * stm32_mavlink_interface__srv__SetEncoderConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STM32_MAVLINK_INTERFACE__SRV__DETAIL__SET_ENCODER_CONFIG__FUNCTIONS_H_
