...
#ifndef STM32_MAVLINK_INTERFACE__SRV__GET_ROBOMASTER_MOTOR_CONFIG_H_
#define STM32_MAVLINK_INTERFACE__SRV__GET_ROBOMASTER_MOTOR_CONFIG_H_
...
#endif  // STM32_MAVLINK_INTERFACE__SRV__GET_ROBOMASTER_MOTOR_CONFIG_H_
