...
bool rogilink_flex_interfaces__msg__frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rogilink_flex_interfaces.msg._frame.Frame", full_classname_dest, 41) == 0);
  }
  rogilink_flex_interfaces__msg__Frame * ros_message = _ros_message;
  {  // frame_id
...
PyObject * rogilink_flex_interfaces__msg__frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rogilink_flex_interfaces.msg._frame");
