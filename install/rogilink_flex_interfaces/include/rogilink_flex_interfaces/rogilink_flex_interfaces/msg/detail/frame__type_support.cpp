...
{
  new (message_memory) rogilink_flex_interfaces::msg::Frame(_init);
}

void Frame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rogilink_flex_interfaces::msg::Frame *>(message_memory);
  typed_message->~Frame();
}
...
void resize_function__Frame__data(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<uint8_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Frame_message_member_array[4] = {
  {
    "frame_id",  // name
    ...
    offsetof(rogilink_flex_interfaces::msg::Frame, frame_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rogilink_flex_interfaces::msg::Frame, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rogilink_flex_interfaces::msg::Frame, data),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__Frame__data  // resize(index) function pointer
  },
  {
    "topic",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rogilink_flex_interfaces::msg::Frame, topic),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Frame_message_members = {
  "rogilink_flex_interfaces::msg",  // message namespace
  "Frame",  // message name
  4,  // number of fields
  sizeof(rogilink_flex_interfaces::msg::Frame),
...
get_message_type_support_handle<rogilink_flex_interfaces::msg::Frame>()
{
  return &::rogilink_flex_interfaces::msg::rosidl_typesupport_introspection_cpp::Frame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rogilink_flex_interfaces, msg, Frame)() {
  return &::rogilink_flex_interfaces::msg::rosidl_typesupport_introspection_cpp::Frame_message_type_support_handle;
}
